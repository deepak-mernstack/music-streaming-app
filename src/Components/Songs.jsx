...
function Songs() {
  ...
  const filteredItems = items.filter((item) => {
    ...
    return (
      ...
      <div className="songs-container" style={{width:"1180px"}}>
        <div className="container mx-auto p-3">
          <h2 className="text-3xl font-semibold mb-4 text-center" style={{fontSize:"30px", color:"white"}}>Songs</h2>
          ...
          <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 g-4">
            {filteredItems.map((item, index) => (
              <div key={item.id} className="col">
                <div className="card" style={{width:"275px", height:"460px"}}>
                  <img
                    src={item.imgUrl}
                    alt="Item Image"
